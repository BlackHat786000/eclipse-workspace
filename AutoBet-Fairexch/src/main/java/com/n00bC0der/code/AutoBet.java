...
public class AutoBet {
	public static void main(String[] args) throws Exception {
		...
		String match_url = "https://geminiexch.com/#/fullmarket/202207145138265/4";
		String punter_lay_team = "Perth Scorchers";	//FAVORITES_TEAM i.e. the team you are betting against at
		float punter_lay_odds = 1.50f;
		//float rebook_lay_odds = 1.80f;
		float punter_lay_amount = 100;
		...
		while(monitor<2) {
			...
			if(favs_lay_odds * 100 <= punter_lay_odds * 100 && !home_back_odds_in_string.equals(away_back_odds_in_string)) {
				...
				new WebDriverWait(driver, 15).until(ExpectedConditions.invisibilityOfElementWithText(By.xpath("//span[@class='to-message toastr-message ng-star-inserted']"),toast_message));
					...
					if(initial_balance.equals(updated_balance))
						{System.out.println("balance still not updated, please check for your bet manually, AutoBet exiting now....");}
