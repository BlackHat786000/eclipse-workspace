package com.n00bc0der.code.Gambler_Dharma_v2.O;
...
public class Gambler_Dharma_v2 {

	public static void main(String[] args) throws InterruptedException, FileNotFoundException {
		
		System.out.println("**************** Gambler's Dharma - Sport's Prediction Using Vedic Astrology Automated Report ****************\n\n");
		...
		String year = sc.nextLine();			if(year.equals("21") || year.equals("22")) { year = "20" + year; }
...
//-------------------------------------------------------------------------------------------------------------------
		...
		Stadiums.put("DCS", "25.041333168");	
		Stadiums.put("DCS", "55.217999128");
		Stadiums.put("DCS", "4");
		
		// Sheikh Zayed Cricket Stadium
		Stadiums.put("SZCS", "24.391165102");	
		Stadiums.put("SZCS", "54.537664516");
		Stadiums.put("SZCS", "4");
		
		// Sharjah Cricket Stadium
		Stadiums.put("SCS", "25.3251586994");	
		Stadiums.put("SCS", "55.419238323");
		Stadiums.put("SCS", "4");
		
		// Old Trafford
		Stadiums.put("OTS", "53.457831502");	
		Stadiums.put("OTS", "-2.288165514");
		Stadiums.put("OTS", "1");
		
		// Stamford Bridge
		Stadiums.put("SBS", "51.475664764");	
		Stadiums.put("SBS", "-0.187999248");
		Stadiums.put("SBS", "1");
		
		// Goodison Park
		Stadiums.put("GPS", "53.43666492");	
		Stadiums.put("GPS", "-2.959829494");
		Stadiums.put("GPS", "1");
		
		// Elland Road
		Stadiums.put("ERS", "53.77333024");	
		Stadiums.put("ERS", "-1.56999772");
		Stadiums.put("ERS", "1");
		
		// King Power Stadium
		Stadiums.put("KPS", "52.618830858");	
		Stadiums.put("KPS", "-1.138666112");
		Stadiums.put("KPS", "1");
		
		// Vicarage Road
		Stadiums.put("VRS", "51.6432324271");	
		Stadiums.put("VRS", "-0.4008900631");
		Stadiums.put("VRS", "1");
		
		// Brentford Community Stadium
		Stadiums.put("BCS", "51.487826382");	
		Stadiums.put("BCS", "-0.28655218712");
		Stadiums.put("BCS", "1");
		
		// Santiago Bernabeu
		Stadiums.put("SBS", "40.45166486");	
		Stadiums.put("SBS", "-3.686163922");
		Stadiums.put("SBS", "2");
		
		String latitude = Iterables.get(Stadiums.get(stadium), 0);
		String longitude = Iterables.get(Stadiums.get(stadium), 1);
		String timezone = Iterables.get(Stadiums.get(stadium), 2);
		
		
		
		
//-------------------------------------------------------------------------------------------------------------------		
//		String name = "32nd Punjab vs Rajasthan";
...
//		String latitude = "25.041333168";
//		String longitude = "55.217999128";
//		String timezone = "4";
//-------------------------------------------------------------------------------------------------------------------
		
		PrintStream o = new PrintStream(new File("C://Users//yadav//Desktop//Gambler_Dharma//" + name + ".txt"));
...
//		WebDriver driver = new OperaDriver(options);
		...
		System.setOut(console);
		System.out.println("\n\n**************** Gambler's Dharma - Sport's Prediction Using Vedic Astrology Automated Report is being generated. This may take several minutes ****************");
		System.setOut(o);
...
//		Thread.sleep(10000);
		...
		for(int i=1; i<=12; i++) {
			...
			for(int j=1; j<=7; j++) {
				...
				if(j == 2) {
					if(planet_prop.charAt(1) == ':') { planet_prop = "0"+planet_prop; if(planet_prop.charAt(4) == ':') { planet_prop = planet_prop.substring(0, 3)+ "0" +planet_prop.substring(3); } }
					if(planet_prop.charAt(4) == ':') { planet_prop = planet_prop.substring(0, 3)+ "0" +planet_prop.substring(3); }
			...
			Multimap<Integer, Integer> cusps = ArrayListMultimap.create();
				...
				for(int i=1; i<=12; i++) {
					...
					for(int j=1; j<=6; j++) {
						...
						String cusp_prop = driver.findElement(By.xpath("/html/body/div[2]/div[2]/div/main/article/div/div[4]/div[2]/div[1]/div/div[1]/div/table/tbody/tr["+i+"]/td["+j+"]")).getText();
						...
						if(j == 2) {
							if(cusp_prop.charAt(1) == ':') { cusp_prop = "0"+cusp_prop; if(cusp_prop.charAt(4) == ':') { cusp_prop = cusp_prop.substring(0, 3)+ "0" +cusp_prop.substring(3); } }
							if(cusp_prop.charAt(4) == ':') { cusp_prop = cusp_prop.substring(0, 3)+ "0" +cusp_prop.substring(3); }
				...
				if(pof_minutes < 0) { pof_minutes = pof_minutes + 21600; }
				int pof_sign = pof_minutes / 1800 + 1; if(pof_sign > 12) { pof_sign = pof_sign % 12; }
...
//----------------------------------------------------------------------------------------------------------------------
				...
				for(int i=1; i<=14; i++) {
					...
					if(cusp_sign == planet_sign) {
						if( ( Math.abs(orb) <= 150 ) && ( planet_house_no == 1 || planet_house_no == 7 || planet_house_no == 10 || planet_house_no == 4 || planet_house_no == 6 || planet_house_no == 12 ) ) {
						System.out.println("\n*************************************************************************************************************************************************************");	
						System.out.println("Lord of "+D1_Lords.get(planets_id.inverse().get(i))+" house "+planets_id.inverse().get(i)+retro.get(Iterables.get(planets.get(i), 0))+" ("+signs_id.inverse().get(planet_sign)+") is on "+planet_house_no+" cusp within orb of "+(orb/60)+"°"+Math.abs(orb%60)+"'");
						System.out.println("*************************************************************************************************************************************************************\n");
					} else if( ( Math.abs(orb) <= 180 ) && ( planet_retro == 1 ) && ( planet_house_no == 1 || planet_house_no == 7 || planet_house_no == 10 || planet_house_no == 4 || planet_house_no == 6 || planet_house_no == 12 ) ) {
						System.out.println("\n*************************************************************************************************************************************************************");	
						System.out.println("Lord of "+D1_Lords.get(planets_id.inverse().get(i))+" house "+planets_id.inverse().get(i)+retro.get(Iterables.get(planets.get(i), 0))+" ("+signs_id.inverse().get(planet_sign)+") is on "+planet_house_no+" cusp within orb of "+(orb/60)+"°"+Math.abs(orb%60)+"' (3° orb for retro planets)");
						System.out.println("*************************************************************************************************************************************************************\n");
					} else if( ( Math.abs(orb) <= 150 ) && ( planet_house_no == 2 || planet_house_no == 8 || planet_house_no == 3 || planet_house_no == 9 || planet_house_no == 5 || planet_house_no == 11 ) ) {
						System.out.println("\n**** Lord of "+D1_Lords.get(planets_id.inverse().get(i))+" house "+planets_id.inverse().get(i)+retro.get(Iterables.get(planets.get(i), 0))+" ("+signs_id.inverse().get(planet_sign)+") is on "+planet_house_no+" cusp within orb of "+(orb/60)+"°"+Math.abs(orb%60)+"' ****\n");
					} else {
						System.out.println("Lord of "+D1_Lords.get(planets_id.inverse().get(i))+" house "+planets_id.inverse().get(i)+retro.get(Iterables.get(planets.get(i), 0))+" ("+signs_id.inverse().get(planet_sign)+") is on "+planet_house_no+" cusp but within orb of "+(orb/60)+"°"+Math.abs(orb%60)+"' (out of 2°30' orb)");
					}
					}
...
//					boolean show = true;
					for(int j=1; j<=12; j++) {
						 ...
						 if( ( cuspal_sign == planet_sign && j != planet_house_no && Math.abs(orb2) <= 150 ) && ( planet_house_no == 1 || planet_house_no == 7 || planet_house_no == 10 || planet_house_no == 4 || planet_house_no == 6 || planet_house_no == 12 ) ) {
//							 if(show) {
//									System.out.println("\n\nStolen Cusps : ");
//									System.out.println("=============\n"); show = false; }
							 System.out.println("\n[STOLEN CUSP] Lord of "+D1_Lords.get(planets_id.inverse().get(i))+" house "+planets_id.inverse().get(i)+retro.get(Iterables.get(planets.get(i), 0))+" ("+signs_id.inverse().get(planet_sign)+") is on "+j+" cusp within orb of "+(orb2/60)+"°"+Math.abs(orb2%60)+"' but moved to "+planet_house_no+" house\n");
						 }
					}
				} bar.setValue(20); Thread.sleep(1000);
...
//---------------------------------------------------------------------------------------------------------------------
				...
				if(navamsa_asc_sign == navamsa_planet_sign) {
					if(Math.abs(orb) <= 150) {
						System.out.println("\n*************************************************************************************************************************************************************");
						System.out.println("Lord of "+D9_Lords.get(planets_id.inverse().get(i))+" house "+planets_id.inverse().get(i)+retro.get(Iterables.get(planets.get(i), 0))+" ("+signs_id.inverse().get(navamsa_planet_sign)+")"+" is in D9 Ascendant (1st) within orb of "+(orb/60)+"°"+Math.abs(orb%60)+"'");
						System.out.println("*************************************************************************************************************************************************************\n");
						d9_first = planets_id.inverse().get(i)+retro.get(Iterables.get(planets.get(i), 0))+" + "+d9_first;
					} else {
						System.out.println("Lord of "+D9_Lords.get(planets_id.inverse().get(i))+" house "+planets_id.inverse().get(i)+retro.get(Iterables.get(planets.get(i), 0))+" ("+signs_id.inverse().get(navamsa_planet_sign)+")"+" is in D9 Ascendant (1st) but within orb of "+(orb/60)+"°"+Math.abs(orb%60)+"' (out of 2°30' orb)");
						d9_first = planets_id.inverse().get(i)+retro.get(Iterables.get(planets.get(i), 0))+" + "+d9_first;
					}
				}
				if(navamsa_dsc_sign == navamsa_planet_sign) {
					if(Math.abs(orb) <= 150) {
						System.out.println("\n*************************************************************************************************************************************************************");
						System.out.println("Lord of "+D9_Lords.get(planets_id.inverse().get(i))+" house "+planets_id.inverse().get(i)+retro.get(Iterables.get(planets.get(i), 0))+" ("+signs_id.inverse().get(navamsa_planet_sign)+")"+" is in D9 Dscendant (7th) within orb of "+(orb/60)+"°"+Math.abs(orb%60)+"'");
						System.out.println("*************************************************************************************************************************************************************\n");
						d9_seventh = planets_id.inverse().get(i)+retro.get(Iterables.get(planets.get(i), 0))+" + "+d9_seventh;
					} else {
						System.out.println("Lord of "+D9_Lords.get(planets_id.inverse().get(i))+" house "+planets_id.inverse().get(i)+retro.get(Iterables.get(planets.get(i), 0))+" ("+signs_id.inverse().get(navamsa_planet_sign)+")"+" is in D9 Dscendant (7th) but within orb of "+(orb/60)+"°"+Math.abs(orb%60)+"' (out of 2°30' orb)");
						d9_seventh = planets_id.inverse().get(i)+retro.get(Iterables.get(planets.get(i), 0))+" + "+d9_seventh;
					}
				}
				if(navamsa_mc_sign == navamsa_planet_sign) {
					if(Math.abs(orb) <= 150) {
						System.out.println("\n*************************************************************************************************************************************************************");
						System.out.println("Lord of "+D9_Lords.get(planets_id.inverse().get(i))+" house "+planets_id.inverse().get(i)+retro.get(Iterables.get(planets.get(i), 0))+" ("+signs_id.inverse().get(navamsa_planet_sign)+")"+ " is in D9 10th within orb of "+(orb/60)+"°"+Math.abs(orb%60)+"'");
						System.out.println("*************************************************************************************************************************************************************\n");
					} else {
						System.out.println("Lord of "+D9_Lords.get(planets_id.inverse().get(i))+" house "+planets_id.inverse().get(i)+retro.get(Iterables.get(planets.get(i), 0))+" ("+signs_id.inverse().get(navamsa_planet_sign)+")"+" is in D9 10th but within orb of "+(orb/60)+"°"+Math.abs(orb%60)+"' (out of 2°30' orb)");
					}
				}
				if(navamsa_ic_sign == navamsa_planet_sign) {
					if(Math.abs(orb) <= 150) {
						System.out.println("\n*************************************************************************************************************************************************************");
						System.out.println("Lord of "+D9_Lords.get(planets_id.inverse().get(i))+" house "+planets_id.inverse().get(i)+retro.get(Iterables.get(planets.get(i), 0))+" ("+signs_id.inverse().get(navamsa_planet_sign)+")"+" is in D9 4th within orb of "+(orb/60)+"°"+Math.abs(orb%60)+"'");
						System.out.println("*************************************************************************************************************************************************************\n");
					} else {
						System.out.println("Lord of "+D9_Lords.get(planets_id.inverse().get(i))+" house "+planets_id.inverse().get(i)+retro.get(Iterables.get(planets.get(i), 0))+" ("+signs_id.inverse().get(navamsa_planet_sign)+")"+" is in D9 4th but within orb of "+(orb/60)+"°"+Math.abs(orb%60)+"' (out of 2°30' orb)");
					}
				}
				...
				bar.setValue(30); Thread.sleep(1000);
...
//-------------------------------------------------------------------------------------------------------------------
				...
				String asc_csl = driver.findElement(By.xpath("/html/body/div[2]/div[2]/div/main/article/div/div[4]/div[2]/div[1]/div/div[1]/div/table/tbody/tr[1]/td[6]")).getText();
				String dsc_csl = driver.findElement(By.xpath("/html/body/div[2]/div[2]/div/main/article/div/div[4]/div[2]/div[1]/div/div[1]/div/table/tbody/tr[7]/td[6]")).getText();
				int ASC_SUB = 0;
				int DSC_SUB = 0;
...
// Calculations of 1st & 7th CSL Star Lord
			...
			for(int i=1; i<=12; i++) {
					...
					else if((i==4 || i==5 || i==7 || i==8 || i==9 || i==12) && ((Iterables.get(house_view.get(i), 0).equals("")) && (Iterables.get(house_view.get(i), 1).equals("")) && (Iterables.get(house_view.get(i), 2).equals("")) && (Iterables.get(house_view.get(i), 3).contains(asc_csl_stars)))) {
						ASC_SUB_STAR = ASC_SUB_STAR - 4; }
					else if((i==1 || i==2 || i==3 || i==6 || i==10 || i==11) && ((Iterables.get(house_view.get(i), 0).equals("")) && (Iterables.get(house_view.get(i), 1).equals("")))) {
					...
					} else if((i==4 || i==5 || i==7 || i==8 || i==9 || i==12) && (s.contains(asc_csl_stars))) {
								ASC_SUB_STAR = ASC_SUB_STAR - cnt;
					}
						cnt = cnt - 1;
					}
			...
			for(int i=1; i<=12; i++) {
					...
					else if((i==4 || i==5 || i==7 || i==8 || i==9 || i==12) && ((Iterables.get(house_view.get(i), 0) == "") && (Iterables.get(house_view.get(i), 1) == "") && (Iterables.get(house_view.get(i), 2) == "" && (Iterables.get(house_view.get(i), 3).contains(dsc_csl_stars))))) {
						DSC_SUB_STAR = DSC_SUB_STAR + 4; }
					else if((i==1 || i==2 || i==3 || i==6 || i==10 || i==11) && ((Iterables.get(house_view.get(i), 0) == "") && (Iterables.get(house_view.get(i), 1) == ""))) {
					...
					} else if((i==4 || i==5 || i==7 || i==8 || i==9 || i==12) && (s.contains(dsc_csl_stars))) {
								DSC_SUB_STAR = DSC_SUB_STAR + cnt;
					}
						cnt = cnt - 1;
					}
...
// Calculations of 1st & 7th CSL Sub Lord
			...
			for(int i=1; i<=12; i++) {
					...
					else if((i==4 || i==5 || i==7 || i==8 || i==9 || i==12) && ((Iterables.get(house_view.get(i), 0).equals("")) && (Iterables.get(house_view.get(i), 1).equals("")) && (Iterables.get(house_view.get(i), 2).equals("")) && (Iterables.get(house_view.get(i), 3).contains(asc_csl_subs)))) {
						ASC_SUB_SUB = ASC_SUB_SUB - 4; }
					else if((i==1 || i==2 || i==3 || i==6 || i==10 || i==11) && ((Iterables.get(house_view.get(i), 0).equals("")) && (Iterables.get(house_view.get(i), 1).equals("")))) {
					...
					} else if((i==4 || i==5 || i==7 || i==8 || i==9 || i==12) && (s.contains(asc_csl_subs))) {
								ASC_SUB_SUB = ASC_SUB_SUB - cnt;
					}
						cnt = cnt - 1;
					}
			...
			System.out.println("1st CSL : "+asc_csl+retro.get(Iterables.get(planets.get(planets_id.get(asc_csl)), 0))+retro.get(Iterables.get(planets.get(planets_id.get(asc_csl)), 6))+" = "+ASC_SUB);
		...
		for(int i=1; i<=12; i++) {
				...
				else if((i==4 || i==5 || i==7 || i==8 || i==9 || i==12) && ((Iterables.get(house_view.get(i), 0) == "") && (Iterables.get(house_view.get(i), 1) == "") && (Iterables.get(house_view.get(i), 2) == "" && (Iterables.get(house_view.get(i), 3).contains(dsc_csl_subs))))) {
					DSC_SUB_SUB = DSC_SUB_SUB + 4; }
				else if((i==1 || i==2 || i==3 || i==6 || i==10 || i==11) && ((Iterables.get(house_view.get(i), 0) == "") && (Iterables.get(house_view.get(i), 1) == ""))) {
				...
				} else if((i==4 || i==5 || i==7 || i==8 || i==9 || i==12) && (s.contains(dsc_csl_subs))) {
							DSC_SUB_SUB = DSC_SUB_SUB + cnt;
				}
					cnt = cnt - 1;
				}
		...
		if(ASC_SUB_SUB == DSC_SUB_SUB) {
			...
			System.out.println("\n7th CSL : "+dsc_csl+retro.get(Iterables.get(planets.get(planets_id.get(dsc_csl)), 0))+retro.get(Iterables.get(planets.get(planets_id.get(dsc_csl)), 6))+" = "+DSC_SUB);
...
//					}
					...
					if((JupiterR == 1 || Jupiter_sign == 4) && (Jupiter == 1 || Jupiter == 3 || Jupiter == 6 || Jupiter == 10 || Jupiter == 11)) {
						ASC_VHQ = ASC_VHQ + 2;
					...
					} else if((JupiterR == 1 || Jupiter_sign == 4) && (Jupiter == 7 || Jupiter == 9 || Jupiter == 12 || Jupiter == 4 || Jupiter == 5)) {
						DSC_VHQ = DSC_VHQ + 2;
						if(Jupiter_sign == 9 || Jupiter_sign == 12) {
							DSC_VHQ = (float) (DSC_VHQ + 0.5);
						}
						...
						if((VenusR == 1 || Venus_sign == 12) && (Venus == 1 || Venus == 3 || Venus == 6 || Venus == 10 || Venus == 11)) {
							ASC_VHQ = ASC_VHQ + 2;
						...
						} else if((VenusR == 1 || Venus_sign == 12) && (Venus == 7 || Venus == 9 || Venus == 12 || Venus == 4 || Venus == 5)) {
							DSC_VHQ = DSC_VHQ + 2;
							if(Venus_sign == 2 || Venus_sign == 7) {
								DSC_VHQ = (float) (DSC_VHQ + 0.5);
							}
						...
						if((MercuryR == 1 || Mercury_sign == 6) && (Mercury == 1 || Mercury == 3 || Mercury == 6 || Mercury == 10 || Mercury == 11)) {
							ASC_VHQ = ASC_VHQ + 2;
							if(Mercury_sign == 3) {
								ASC_VHQ = (float) (ASC_VHQ + 0.5);
							}
						...
						} else if((MercuryR == 1 || Mercury_sign == 6) && (Mercury == 7 || Mercury == 9 || Mercury == 12 || Mercury == 4 || Mercury == 5)) {
							DSC_VHQ = DSC_VHQ + 2;
							if(Mercury_sign == 3) {
								DSC_VHQ = (float) (DSC_VHQ + 0.5);
							}
...
//-------------------------------------------------------------------------------------------------------------------
					...
					if(l1_sign == 5 && Math.abs(l1_regulus) <= 60) {
						System.out.println("L1 "+planets_id.inverse().get(l1)+" conjuct regulus within orb of "+(l1_regulus/60)+"°"+Math.abs(l1_regulus%60)+"'");
					}
					if(l7_sign == 5 && Math.abs(l7_regulus) <= 60) {
						System.out.println("L7 "+planets_id.inverse().get(l7)+" conjuct regulus within orb of "+(l7_regulus/60)+"°"+Math.abs(l7_regulus%60)+"'");
					}
					if(l10_sign == 5 && Math.abs(l10_regulus) <= 60) {
						System.out.println("L10 "+planets_id.inverse().get(l10)+" conjuct regulus within orb of "+(l10_regulus/60)+"°"+Math.abs(l10_regulus%60)+"'");
					}
					if(l4_sign == 5 && Math.abs(l4_regulus) <= 60) {
						System.out.println("L4 "+planets_id.inverse().get(l4)+" conjuct regulus within orb of "+(l4_regulus/60)+"°"+Math.abs(l4_regulus%60)+"'");
					}
					
					
					if(l1_sign == 3 && Math.abs(l1_pollux) <= 60) {
						System.out.println("L1 "+planets_id.inverse().get(l1)+" conjuct pollux within orb of "+(l1_pollux/60)+"°"+Math.abs(l1_pollux%60)+"'");
					}
					if(l7_sign == 3 && Math.abs(l7_pollux) <= 60) {
						System.out.println("L7 "+planets_id.inverse().get(l7)+" conjuct pollux within orb of "+(l7_pollux/60)+"°"+Math.abs(l7_pollux%60)+"'");
					}
					if(l10_sign == 3 && Math.abs(l10_pollux) <= 60) {
						System.out.println("L10 "+planets_id.inverse().get(l10)+" conjuct pollux within orb of "+(l10_pollux/60)+"°"+Math.abs(l10_pollux%60)+"'");
					}
					if(l4_sign == 3 && Math.abs(l4_pollux) <= 60) {
						System.out.println("L4 "+planets_id.inverse().get(l4)+" conjuct pollux within orb of "+(l4_pollux/60)+"°"+Math.abs(l4_pollux%60)+"'");
					}
					
					
					if(l1_sign == 7 && Math.abs(l1_zuben) <= 60) {
						System.out.println("L1 "+planets_id.inverse().get(l1)+" conjuct zuben elgenubi within orb of "+(l1_zuben/60)+"°"+Math.abs(l1_zuben%60)+"'");
					}
					if(l7_sign == 7 && Math.abs(l7_zuben) <= 60) {
						System.out.println("L7 "+planets_id.inverse().get(l7)+" conjuct zuben elgenubi within orb of "+(l7_zuben/60)+"°"+Math.abs(l7_zuben%60)+"'");
					}
					if(l10_sign == 7 && Math.abs(l10_zuben) <= 60) {
						System.out.println("L10 "+planets_id.inverse().get(l10)+" conjuct zuben elgenubi within orb of "+(l10_zuben/60)+"°"+Math.abs(l10_zuben%60)+"'");
					}
					if(l4_sign == 7 && Math.abs(l4_zuben) <= 60) {
						System.out.println("L4 "+planets_id.inverse().get(l4)+" conjuct zuben elgenubi within orb of "+(l4_zuben/60)+"°"+Math.abs(l4_zuben%60)+"'");
					}
					
					
					if(l1_sign == 3 && Math.abs(l1_bettelguese) <= 60) {
						System.out.println("L1 "+planets_id.inverse().get(l1)+" conjuct bettelguese within orb of "+(l1_bettelguese/60)+"°"+Math.abs(l1_bettelguese%60)+"'");
					}
					if(l7_sign == 3 && Math.abs(l7_bettelguese) <= 60) {
						System.out.println("L7 "+planets_id.inverse().get(l7)+" conjuct bettelguese within orb of "+(l7_bettelguese/60)+"°"+Math.abs(l7_bettelguese%60)+"'");
					}
					if(l10_sign == 3 && Math.abs(l10_bettelguese) <= 60) {
						System.out.println("L10 "+planets_id.inverse().get(l10)+" conjuct bettelguese within orb of "+(l10_bettelguese/60)+"°"+Math.abs(l10_bettelguese%60)+"'");
					}
					if(l4_sign == 3 && Math.abs(l4_bettelguese) <= 60) {
						System.out.println("L4 "+planets_id.inverse().get(l4)+" conjuct bettelguese within orb of "+(l4_bettelguese/60)+"°"+Math.abs(l4_bettelguese%60)+"'");
					}
					
					
					if(l1_sign == 6 && Math.abs(l1_spica) <= 60) {
						System.out.println("L1 "+planets_id.inverse().get(l1)+" conjuct spica within orb of "+(l1_spica/60)+"°"+Math.abs(l1_spica%60)+"'");
					}
					if(l7_sign == 6 && Math.abs(l7_spica) <= 60) {
						System.out.println("L7 "+planets_id.inverse().get(l7)+" conjuct spica within orb of "+(l7_spica/60)+"°"+Math.abs(l7_spica%60)+"'");
					}
					if(l10_sign == 6 && Math.abs(l10_spica) <= 60) {
						System.out.println("L10 "+planets_id.inverse().get(l10)+" conjuct spica within orb of "+(l10_spica/60)+"°"+Math.abs(l10_spica%60)+"'");
					}
					if(l4_sign == 6 && Math.abs(l4_spica) <= 60) {
						System.out.println("L4 "+planets_id.inverse().get(l4)+" conjuct spica within orb of "+(l4_spica/60)+"°"+Math.abs(l4_spica%60)+"'");
					}
					
					bar.setValue(70); Thread.sleep(1000);
...
//-------------------------------------------------------------------------------------------------------------------
					...
					System.out.println("Part of Fortune (POF) : "+pof_minutes/60+"°"+pof_minutes%60+"' "+signs_id.inverse().get(pof_sign)+"\n");
					...
					if(MOON_minutes < L1_minutes && L1 != 2) {
						if(L1_orb <= 180) {
							...
							System.out.println("Moon is applying to sextile L1 "+planets_id.inverse().get(L1)+" within orb of "+(L1_orb/60)+"°"+(L1_orb%60)+"'");
							}
							else if(Math.abs(L1_houseno - MOON_houseno) == 3) {
								System.out.println("Moon is applying to square L1 "+planets_id.inverse().get(L1)+" within orb of "+(L1_orb/60)+"°"+(L1_orb%60)+"'");	
							}
							else if(Math.abs(L1_houseno - MOON_houseno) == 6) {
								System.out.println("Moon is applying to oppose L1 "+planets_id.inverse().get(L1)+" within orb of "+(L1_orb/60)+"°"+(L1_orb%60)+"'");
							}
							else if(Math.abs(L1_houseno - MOON_houseno) == 0) {
								System.out.println("Moon is applying to conjuct L1 "+planets_id.inverse().get(L1)+" within orb of "+(L1_orb/60)+"°"+(L1_orb%60)+"'");
							}
						}
					}
					...
					if(MOON_minutes < L7_minutes && L7 != 2) {
						if(L7_orb <= 180) {
							...
							System.out.println("Moon is applying to sextile L7 "+planets_id.inverse().get(L7)+" within orb of "+(L7_orb/60)+"°"+(L7_orb%60)+"'");
							}
							else if(Math.abs(L7_houseno - MOON_houseno) == 3) {
								System.out.println("Moon is applying to square L7 "+planets_id.inverse().get(L7)+" within orb of "+(L7_orb/60)+"°"+(L7_orb%60)+"'");	
							}
							else if(Math.abs(L7_houseno - MOON_houseno) == 6) {
								System.out.println("Moon is applying to oppose L7 "+planets_id.inverse().get(L7)+" within orb of "+(L7_orb/60)+"°"+(L7_orb%60)+"'");
							}
							else if(Math.abs(L7_houseno - MOON_houseno) == 0) {
								System.out.println("Moon is applying to conjuct L7 "+planets_id.inverse().get(L7)+" within orb of "+(L7_orb/60)+"°"+(L7_orb%60)+"'");
							}
						}
					}
					...
					if(MOON_minutes < L10_minutes && L10 != 2) {
						if(L10_orb <= 180) {
							...
							System.out.println("Moon is applying to sextile L10 "+planets_id.inverse().get(L10)+" within orb of "+(L10_orb/60)+"°"+(L10_orb%60)+"'");
							}
							else if(Math.abs(L10_houseno - MOON_houseno) == 3) {
								System.out.println("Moon is applying to square L10 "+planets_id.inverse().get(L10)+" within orb of "+(L10_orb/60)+"°"+(L10_orb%60)+"'");	
							}
							else if(Math.abs(L10_houseno - MOON_houseno) == 6) {
								System.out.println("Moon is applying to oppose L10 "+planets_id.inverse().get(L10)+" within orb of "+(L10_orb/60)+"°"+(L10_orb%60)+"'");
							}
							else if(Math.abs(L10_houseno - MOON_houseno) == 0) {
								System.out.println("Moon is applying to conjuct L10 "+planets_id.inverse().get(L10)+" within orb of "+(L10_orb/60)+"°"+(L10_orb%60)+"'");
							}
						}
					}
					...
					if(MOON_minutes < L4_minutes && L4 != 2) {
						if(L4_orb <= 180) {
							...
							System.out.println("Moon is applying to sextile L4 "+planets_id.inverse().get(L4)+" within orb of "+(L4_orb/60)+"°"+(L4_orb%60)+"'");
							}
							else if(Math.abs(L4_houseno - MOON_houseno) == 3) {
								System.out.println("Moon is applying to square L4 "+planets_id.inverse().get(L4)+" within orb of "+(L4_orb/60)+"°"+(L4_orb%60)+"'");	
							}
							else if(Math.abs(L4_houseno - MOON_houseno) == 6) {
								System.out.println("Moon is applying to oppose L4 "+planets_id.inverse().get(L4)+" within orb of "+(L4_orb/60)+"°"+(L4_orb%60)+"'");
							}
							else if(Math.abs(L4_houseno - MOON_houseno) == 0) {
								System.out.println("Moon is applying to conjuct L4 "+planets_id.inverse().get(L4)+" within orb of "+(L4_orb/60)+"°"+(L4_orb%60)+"'");
							}
						}
					}
					...
					if(MOON_minutes < POF_minutes) {
						if(POF_orb <= 180) {
							...
							System.out.println("Moon is applying to sextile POF within orb of "+(POF_orb/60)+"°"+(POF_orb%60)+"'");
							}
							else if(Math.abs(POF_houseno - MOON_houseno) == 3) {
								System.out.println("Moon is applying to square POF within orb of "+(POF_orb/60)+"°"+(POF_orb%60)+"'");	
							}
							else if(Math.abs(POF_houseno - MOON_houseno) == 6) {
								System.out.println("Moon is applying to oppose POF within orb of "+(POF_orb/60)+"°"+(POF_orb%60)+"'");
							}
							else if(Math.abs(POF_houseno - MOON_houseno) == 0) {
								System.out.println("Moon is applying to conjuct POF within orb of "+(POF_orb/60)+"°"+(POF_orb%60)+"'");
							}
						}
					}
					...
					if(L1_minutes < POF_minutes) {
						if(L1_poforb <= 180) {
							if(Math.abs(POF_houseno - L1_houseno) == 6) {
								System.out.println("L1 "+planets_id.inverse().get(L1)+" is applying to oppose POF within orb of "+(L1_poforb/60)+"°"+(L1_poforb%60)+"'");
							}
							else if(Math.abs(POF_houseno - L1_houseno) == 0) {
								System.out.println("L1 "+planets_id.inverse().get(L1)+" is applying to conjuct POF within orb of "+(L1_poforb/60)+"°"+(L1_poforb%60)+"'");
							}
						}
					}
					...
					if(L7_minutes < POF_minutes) {
						if(L7_poforb <= 180) {
							if(Math.abs(POF_houseno - L7_houseno) == 6) {
								System.out.println("L7 "+planets_id.inverse().get(L7)+" is applying to oppose POF within orb of "+(L7_poforb/60)+"°"+(L7_poforb%60)+"'");
							}
							else if(Math.abs(POF_houseno - L7_houseno) == 0) {
								System.out.println("L7 "+planets_id.inverse().get(L7)+" is applying to conjuct POF within orb of "+(L7_poforb/60)+"°"+(L7_poforb%60)+"'");
							}
						}
					}
					...
					if(L10_minutes < POF_minutes) {
						if(L10_poforb <= 180) {
							if(Math.abs(POF_houseno - L10_houseno) == 6) {
								System.out.println("L10 "+planets_id.inverse().get(L10)+" is applying to oppose POF within orb of "+(L10_poforb/60)+"°"+(L10_poforb%60)+"'");
							}
							else if(Math.abs(POF_houseno - L10_houseno) == 0) {
								System.out.println("L10 "+planets_id.inverse().get(L10)+" is applying to conjuct POF within orb of "+(L10_poforb/60)+"°"+(L10_poforb%60)+"'");
							}
						}
					}
					...
					if(L4_minutes < POF_minutes) {
						if(L4_poforb <= 180) {
							if(Math.abs(POF_houseno - L4_houseno) == 6) {
								System.out.println("L4 "+planets_id.inverse().get(L4)+" is applying to oppose POF within orb of "+(L4_poforb/60)+"°"+(L4_poforb%60)+"'");
							}
							else if(Math.abs(POF_houseno - L4_houseno) == 0) {
								System.out.println("L4 "+planets_id.inverse().get(L4)+" is applying to conjuct POF within orb of "+(L4_poforb/60)+"°"+(L4_poforb%60)+"'");
							}
						}
					}	
...
//-------------------------------------------------------------------------------------------------------------------
					...
					if(Math.abs(L1_ketorb) <= 120 && ketu_houseno == L1_houseno) {
						System.out.println("L1 "+planets_id.inverse().get(L1)+" conjuct ketu within orb of "+(L1_ketorb/60)+"°"+Math.abs(L1_ketorb%60)+"'");
					}
					if(Math.abs(L1_ukorb) <= 120 && upaketu_houseno == L1_houseno) {
						System.out.println("L1 "+planets_id.inverse().get(L1)+" conjuct upaketu within orb of "+(L1_ukorb/60)+"°"+Math.abs(L1_ukorb%60)+"'");
					}
					if(Math.abs(L1_neporb) <= 120 && neptune_houseno == L1_houseno) {
						System.out.println("L1 "+planets_id.inverse().get(L1)+" conjuct neptune within orb of "+(L1_neporb/60)+"°"+Math.abs(L1_neporb%60)+"'");
					}
					if(Math.abs(L1_pluorb) <= 120 && pluto_houseno == L1_houseno) {
						System.out.println("L1 "+planets_id.inverse().get(L1)+" conjuct pluto within orb of "+(L1_pluorb/60)+"°"+Math.abs(L1_pluorb%60)+"'");
					}
					if(Math.abs(L1_sunorb) <= 120 && sunny_houseno == L1_houseno && L1 != 1) {
						System.out.println("L1 "+planets_id.inverse().get(L1)+" is combusted by sun within orb of "+(L1_sunorb/60)+"°"+Math.abs(L1_sunorb%60)+"'");
					}
					if(Math.abs(L1_rahuorb) <= 120 && rahu_houseno == L1_houseno) {
						System.out.println("L1 "+planets_id.inverse().get(L1)+" conjuct rahu within orb of "+(L1_rahuorb/60)+"°"+Math.abs(L1_rahuorb%60)+"'");
					}
					if(Math.abs(L1_uraorb) <= 120 && uranus_houseno == L1_houseno) {
						System.out.println("L1 "+planets_id.inverse().get(L1)+" conjuct uranus within orb of "+(L1_uraorb/60)+"°"+Math.abs(L1_uraorb%60)+"'");
					}
					
					
					if(Math.abs(L7_ketorb) <= 120 && ketu_houseno == L7_houseno) {
						System.out.println("L7 "+planets_id.inverse().get(L7)+" conjuct ketu within orb of "+(L7_ketorb/60)+"°"+Math.abs(L7_ketorb%60)+"'");
					}
					if(Math.abs(L7_ukorb) <= 120 && upaketu_houseno == L7_houseno) {
						System.out.println("L7 "+planets_id.inverse().get(L7)+" conjuct upaketu within orb of "+(L7_ukorb/60)+"°"+Math.abs(L7_ukorb%60)+"'");
					}
					if(Math.abs(L7_neporb) <= 120 && neptune_houseno == L7_houseno) {
						System.out.println("L7 "+planets_id.inverse().get(L7)+" conjuct neptune within orb of "+(L7_neporb/60)+"°"+Math.abs(L7_neporb%60)+"'");
					}
					if(Math.abs(L7_pluorb) <= 120 && pluto_houseno == L7_houseno) {
						System.out.println("L7 "+planets_id.inverse().get(L7)+" conjuct pluto within orb of "+(L7_pluorb/60)+"°"+Math.abs(L7_pluorb%60)+"'");
					}
					if(Math.abs(L7_sunorb) <= 120 && sunny_houseno == L7_houseno && L7 != 1) {
						System.out.println("L7 "+planets_id.inverse().get(L7)+" is combusted by sun within orb of "+(L7_sunorb/60)+"°"+Math.abs(L7_sunorb%60)+"'");
					}
					if(Math.abs(L7_rahuorb) <= 120 && rahu_houseno == L7_houseno) {
						System.out.println("L7 "+planets_id.inverse().get(L7)+" conjuct rahu within orb of "+(L7_rahuorb/60)+"°"+Math.abs(L7_rahuorb%60)+"'");
					}
					if(Math.abs(L7_uraorb) <= 120 && uranus_houseno == L7_houseno) {
						System.out.println("L7 "+planets_id.inverse().get(L7)+" conjuct uranus within orb of "+(L7_uraorb/60)+"°"+Math.abs(L7_uraorb%60)+"'");
					}
					
					
					if(Math.abs(L10_ketorb) <= 120 && ketu_houseno == L10_houseno) {
						System.out.println("L10 "+planets_id.inverse().get(L10)+" conjuct ketu within orb of "+(L10_ketorb/60)+"°"+Math.abs(L10_ketorb%60)+"'");
					}
					if(Math.abs(L10_ukorb) <= 120 && upaketu_houseno == L10_houseno) {
						System.out.println("L10 "+planets_id.inverse().get(L10)+" conjuct upaketu within orb of "+(L10_ukorb/60)+"°"+Math.abs(L10_ukorb%60)+"'");
					}
					if(Math.abs(L10_neporb) <= 120 && neptune_houseno == L10_houseno) {
						System.out.println("L10 "+planets_id.inverse().get(L10)+" conjuct neptune within orb of "+(L10_neporb/60)+"°"+Math.abs(L10_neporb%60)+"'");
					}
					if(Math.abs(L10_pluorb) <= 120 && pluto_houseno == L10_houseno) {
						System.out.println("L10 "+planets_id.inverse().get(L10)+" conjuct pluto within orb of "+(L10_pluorb/60)+"°"+Math.abs(L10_pluorb%60)+"'");
					}
					if(Math.abs(L10_sunorb) <= 120 && sunny_houseno == L10_houseno && L10 != 1) {
						System.out.println("L10 "+planets_id.inverse().get(L10)+" is combusted by sun within orb of "+(L10_sunorb/60)+"°"+Math.abs(L10_sunorb%60)+"'");
					}
					if(Math.abs(L10_rahuorb) <= 120 && rahu_houseno == L10_houseno) {
						System.out.println("L10 "+planets_id.inverse().get(L10)+" conjuct rahu within orb of "+(L10_rahuorb/60)+"°"+Math.abs(L10_rahuorb%60)+"'");
					}
					if(Math.abs(L10_uraorb) <= 120 && uranus_houseno == L10_houseno) {
						System.out.println("L10 "+planets_id.inverse().get(L10)+" conjuct uranus within orb of "+(L10_uraorb/60)+"°"+Math.abs(L10_uraorb%60)+"'");
					}
					
					
					if(Math.abs(L4_ketorb) <= 120 && ketu_houseno == L4_houseno) {
						System.out.println("L4 "+planets_id.inverse().get(L4)+" conjuct ketu within orb of "+(L4_ketorb/60)+"°"+Math.abs(L4_ketorb%60)+"'");
					}
					if(Math.abs(L4_ukorb) <= 120 && upaketu_houseno == L4_houseno) {
						System.out.println("L4 "+planets_id.inverse().get(L4)+" conjuct upaketu within orb of "+(L4_ukorb/60)+"°"+Math.abs(L4_ukorb%60)+"'");
					}
					if(Math.abs(L4_neporb) <= 120 && neptune_houseno == L4_houseno) {
						System.out.println("L4 "+planets_id.inverse().get(L4)+" conjuct neptune within orb of "+(L4_neporb/60)+"°"+Math.abs(L4_neporb%60)+"'");
					}
					if(Math.abs(L4_pluorb) <= 120 && pluto_houseno == L4_houseno) {
						System.out.println("L4 "+planets_id.inverse().get(L4)+" conjuct pluto within orb of "+(L4_pluorb/60)+"°"+Math.abs(L4_pluorb%60)+"'");
					}
					if(Math.abs(L4_sunorb) <= 120 && sunny_houseno == L4_houseno && L4 != 1) {
						System.out.println("L4 "+planets_id.inverse().get(L4)+" is combusted by sun within orb of "+(L4_sunorb/60)+"°"+Math.abs(L4_sunorb%60)+"'");
					}
					if(Math.abs(L4_rahuorb) <= 120 && rahu_houseno == L4_houseno) {
						System.out.println("L4 "+planets_id.inverse().get(L4)+" conjuct rahu within orb of "+(L4_rahuorb/60)+"°"+Math.abs(L4_rahuorb%60)+"'");
					}
					if(Math.abs(L4_uraorb) <= 120 && uranus_houseno == L4_houseno) {
						System.out.println("L4 "+planets_id.inverse().get(L4)+" conjuct uranus within orb of "+(L4_uraorb/60)+"°"+Math.abs(L4_uraorb%60)+"'");
					}
					
					if(Math.abs(POF_ketorb) <= 120 && ketu_houseno == POF_houseno) {
						System.out.println("POF conjuct ketu within orb of "+(POF_ketorb/60)+"°"+Math.abs(POF_ketorb%60)+"'");
					}
					if(Math.abs(POF_ukorb) <= 120 && upaketu_houseno == POF_houseno) {
						System.out.println("POF conjuct upaketu within orb of "+(POF_ukorb/60)+"°"+Math.abs(POF_ukorb%60)+"'");
					}
					if(Math.abs(POF_neporb) <= 120 && neptune_houseno == POF_houseno) {
						System.out.println("POF conjuct neptune within orb of "+(POF_neporb/60)+"°"+Math.abs(POF_neporb%60)+"'");
					}
					if(Math.abs(POF_pluorb) <= 120 && pluto_houseno == POF_houseno) {
						System.out.println("POF conjuct pluto within orb of "+(POF_pluorb/60)+"°"+Math.abs(POF_pluorb%60)+"'");
					}
					if(Math.abs(POF_sunorb) <= 120 && sunny_houseno == POF_houseno) {
						System.out.println("POF is combusted by sun within orb of "+(POF_sunorb/60)+"°"+Math.abs(POF_sunorb%60)+"'");
					}
					if(Math.abs(POF_rahuorb) <= 120 && rahu_houseno == POF_houseno) {
						System.out.println("POF conjuct rahu within orb of "+(POF_rahuorb/60)+"°"+Math.abs(POF_rahuorb%60)+"'");
					}
					if(Math.abs(POF_uraorb) <= 120 && uranus_houseno == POF_houseno) {
						System.out.println("POF conjuct uranus within orb of "+(POF_uraorb/60)+"°"+Math.abs(POF_uraorb%60)+"'");
					}	
...
//------------------------------------------------------------------------------------------------------------------
					...
					if(L1_starlord_position == 1 ) {
						System.out.println("\nASC Lord's Star Lord "+planets_id.inverse().get(L1_starlord)+" is sitting in ASC itself, Hence Star Lord Reversal is not applicable in this chart");
					}
					if(L7_starlord_position == 7 ) {
						System.out.println("\nDSC Lord's Star Lord "+planets_id.inverse().get(L7_starlord)+" is sitting in DSC itself, Hence Star Lord Reversal is not applicable in this chart");
					}	
					if(L1_starlord == L7) {
					...
					if(L1_starlord_position == 7) {
						System.out.println("\nASC Lord's Star Lord "+planets_id.inverse().get(L1_starlord)+" is sitting in DSC, Hence Star Lord Reversal is applicable in this chart");
						flag = false;
					}
					if(L7_starlord_position == 1) {
						System.out.println("\nDSC Lord's Star Lord "+planets_id.inverse().get(L7_starlord)+" is sitting in ASC, Hence Star Lord Reversal is applicable in this chart");
						flag = false;
					}
					if(flag) {
					...
					if(L1_houseno == 1 && L7_houseno == 7) {
						System.out.println("\n[EXPERIMENTAL] : ASC Lord "+planets_id.inverse().get(L1)+" and DSC Lord "+planets_id.inverse().get(L7)+" are in ASCENDANT and DSCENDANT respectively");
					}
					if(L1_houseno == 7 && L7_houseno == 1) {
						System.out.println("\n[EXPERIMENTAL] : ASC Lord "+planets_id.inverse().get(L1)+" is in DSC and DSC Lord "+planets_id.inverse().get(L7)+" is in ASC");
					}
...
//------------------------------------------------------------------------------------------------------------------
					...
					driver.quit(); bar.setString("Done! :)");
					frame.setVisible(false);
					frame.dispose();
					
					System.setOut(console);
					System.out.println("\n\n\n\n\n\n\n\n**************** Your Gambler's Dharma - Sport's Prediction Using Vedic Astrology Automated Report has been generated successfully. Thank You for your patience ****************");
