...
public class MyFrame extends JFrame {
	...
	MyFrame() {
		...
		String mode[] = {"STANDARD","AUTO LAY ANY","REBOOK CUT LOSS","REBOOK AS YOU WANT","LAY THEN BACK CUT LOSS","LAY THEN BACK AS YOU WANT"};
		
		setTitle("AutoBet v3.2 - GeminiExch + FairExch9");
		setSize(470, 480);
		setLocation(100, 100);
        ...
        MODE.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent event) {
                ...
                if(selected.toString().equals("STANDARD")) {
                	RLO.setText("");
                	RLA.setText("");
                	PBO.setText("");
                	PBA.setText("");
