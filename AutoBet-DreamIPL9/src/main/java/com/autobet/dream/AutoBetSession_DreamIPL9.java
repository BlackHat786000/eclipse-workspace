...
public class AutoBetSession_DreamIPL9 {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n********** Welcome To Punter's AutoBetSession v3.2 (DreamIPL9) - set the session both sides as you want **********\n\n");
		...
		System.out.println("\nLogging in....\n");
		wait.until(ExpectedConditions.elementToBeClickable(By.id("txt_phone"))).sendKeys("rahu9");
		wait.until(ExpectedConditions.elementToBeClickable(By.id("txt_password"))).sendKeys("Iaminsane@786");
